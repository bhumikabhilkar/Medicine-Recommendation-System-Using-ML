...
def home():
    if request.method == 'POST':
        ...
        if symptoms == "Symptoms":
            ...
            return render_template('EnterSymptoms.html', message=message)
        else:
            ...
            dis_des, precautions, medications, rec_diet, workout = helper(
                predicted_disease)
            print(dis_des, precautions, medications, rec_diet, workout)
            my_precautions = []
            for i in precautions[0]:
                my_precautions.append(i)

            return render_template('EnterSymptoms.html', predicted_disease=predicted_disease, dis_des=dis_des,
                                   my_precautions=my_precautions, medications=medications, my_diet=rec_diet,
                                   workout=workout)

    return render_template('EnterSymptoms.html')
